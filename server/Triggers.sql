...
BEGIN
	...
	UPDATE products@site1 SET quantityInStock = prodQuant WHERE id = :NEW.pid;
	...
	UPDATE products@site1 SET totalQuantitySold = totSold WHERE id = :NEW.pid;
...
BEGIN
	...
	UPDATE products@site1 SET quantityInStock = prodQuant WHERE id = :OLD.id;
	DBMS_OUTPUT.PUT_LINE('CURRENT PRODUCT QUANTITY ' || prodQuant);
	...
	UPDATE products@site1 SET totalQuantitySold = totSold WHERE id = :OLD.pid;
	DBMS_OUTPUT.PUT_LINE('TOTAL QUANTITY SOLD : ' || totSold);
